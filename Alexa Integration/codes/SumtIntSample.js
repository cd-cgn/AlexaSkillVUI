...
const NavigateToDevPlan_Handler =  {
    ...
    handle(handlerInput) {
        ...
        let say = 'Hello from NavigateToDevPlan. ';
...
const ListAllTasksIntent_Handler =  {
    ...
    handle(handlerInput) {
        ...
        let say = 'Hello from ListAllTasksIntent. ';
...
const TaskStatusIntent_Handler =  {
    ...
    handle(handlerInput) {
        ...
        let say = 'Hello from TaskStatusIntent. ';
        ...
        //   SLOT: taskname 
        if (slotValues.taskname.heardAs) {
            slotStatus += ' slot taskname was heard as ' + slotValues.taskname.heardAs + '. ';
        } else {
            slotStatus += 'slot taskname is empty. ';
        }
        if (slotValues.taskname.ERstatus === 'ER_SUCCESS_MATCH') {
            slotStatus += 'a valid ';
            if(slotValues.taskname.resolved !== slotValues.taskname.heardAs) {
                slotStatus += 'synonym for ' + slotValues.taskname.resolved + '. '; 
                } else {
                slotStatus += 'match. '
            } // else {
                //
        }
        if (slotValues.taskname.ERstatus === 'ER_SUCCESS_NO_MATCH') {
            slotStatus += 'which did not match any slot value. ';
            console.log('***** consider adding "' + slotValues.taskname.heardAs + '" to the custom slot type used by slot taskname! '); 
        }

        if( (slotValues.taskname.ERstatus === 'ER_SUCCESS_NO_MATCH') ||  (!slotValues.taskname.heardAs) ) {
            slotStatus += 'A few valid values are, ' + sayArray(getExampleSlotValues('TaskStatusIntent','taskname'), 'or');
        }
  ...
  "interactionModel": {
    "languageModel": {
      ...
      "intents": [
        ...
        {
          "name": "NavigateToDevPlan",
          "slots": [],
          "samples": [
            "yeah let's try development plan.",
            "lets go with development plan",
            "development plan",
            "take me to development plan",
        ...
        },
        {
          ...
          "slots": [],
          "samples": [
            "yeah list all the tasks",
            "list all the task",
            "all tasks in dev plan",
            "ok let's list all the tasks",
            "all tasks",
            "Tell me my all tasks",
            "Tell me all tasks in my development plan"
          ]
        },
        {
          "name": "TaskStatusIntent",
          "slots": [
            {
              "name": "taskname",
              "type": "TASKNAME"
          ...
          "samples": [
            ...
            "{taskname}",
            "status of that {taskname} please",
            "what's the status of this {taskname}",
            "tell me the status of new {taskname}",
            "What is the status of {taskname}"
          ]
        },
        {
          "name": "LaunchRequest"
